...
class GPTEngineRunner:
    ...
    def __call__(self, inputs):
        ...
        self.length_penalty = torch.FloatTensor([1.0])
        ...
        if self.num_beams == 1:
            ...
            final_output_ids = self.gather_tree(
                ...
                self.end_ids, input_lengths, self.cum_log_probs, self.length_penalty,
                self.batch_size, self.num_beams,
...
def main():
    ...
    # python3 -m code.gptj.tensorrt.infer --engine_file /home/scratch.zhihanj_sw/gitlab_root/tekit/examples/gptj/gptj_engine_from_hf_h100/gptj_float16_tp1_rank0.engine --num_samples=2 --batch_size=2 --skip_engine_build
    # Torch
