...
add_systems("H100_PCIe_80GB_ARMx{}", "H100-PCIe-80GB_aarch64x{}", KnownCPU.Neoverse_N1_ARM.value,
            KnownGPU.H100_PCIe_80GB.value, [1, 2, 4, 8], Memory(100, ByteSuffix.GiB))
add_systems("H100_SXM_80GBx{}", "GIGABYTE-G593-SD0_H100-SXM-80GBx{}", KnownCPU.Intel_Xeon_Platinum_8480P.value,
            KnownGPU.H100_SXM_80GB.value, [8], Memory(30, ByteSuffix.GiB))
