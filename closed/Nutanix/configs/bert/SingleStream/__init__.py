...
class NX_3155G_G8_A100_PCIe_80GBx2(SingleStreamGPUBaseConfig):
    system = KnownSystem.NX_3155G_G8_A100_PCIe_80GBx2
    enable_interleaved = False
    single_stream_expected_latency_ns = 1600000
    

@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NX_3155G_G8_A100_PCIe_80GBx2_HighAccuracy(NX_3155G_G8_A100_PCIe_80GBx2):
    precision = "fp16"
    single_stream_expected_latency_ns = NX_3155G_G8_A100_PCIe_80GBx2.single_stream_expected_latency_ns * 2


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NX_3155G_G8_A100_PCIe_80GBx2_Triton(NX_3155G_G8_A100_PCIe_80GBx2):
    use_triton = True



@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NX_3155G_G8_A100_PCIe_80GBx2_HighAccuracy_Triton(NX_3155G_G8_A100_PCIe_80GBx2_HighAccuracy):
    use_triton = True
