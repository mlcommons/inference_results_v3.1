...
def get_args():
    ...
    parser.add_argument("--int8-model-dir", default='dlrm_int8.pt', type=str, metavar='PATH',
...
def main():
    ...
    if args.output:
        ...
        if args.use_int8:
            ...
            if os.path.exists(args.int8_model_dir):
                copyfile(args.int8_model_dir, output_dir + "/" + args.int8_model_dir)
        os.chdir(output_dir)
