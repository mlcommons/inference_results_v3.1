  ...
  cd ..; cp ${WORKDIR}/inference/mlperf.conf ${REPODIR}/closed/Intel/code/dlrm-v2-99/pytorch-cpu-int8/.
  ...
  git checkout 7256d0848ba81bb802dd33fca0e33049a751db58
  git apply ${REPODIR}/closed/Intel/code/dlrm-v2-99/pytorch-cpu-int8/ipex.patch
  git submodule sync
  git submodule update --init --recursive
  ...
  git submodule update --init --recursive
  cd mkl-dnn
  patch -p1 < ${REPODIR}/closed/Intel/code/dlrm-v2-99/pytorch-cpu-int8/onednngraph.patch
  git log -1
