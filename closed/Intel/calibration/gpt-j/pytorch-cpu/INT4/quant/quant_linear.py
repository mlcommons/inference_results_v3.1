...
class QuantLinear(nn.Module):
    ...
    def pack(self, linear, scales, zeros, g_idx=None):
        ...
        # TODO: We got accuracy issue with int4 weight (wrong data in weight tensor)
        #       So, we just save bf16 weight here. It's already updated during calibration.
        if self.bits == 4:
            self.qweight = linear.weight.data
        else:
