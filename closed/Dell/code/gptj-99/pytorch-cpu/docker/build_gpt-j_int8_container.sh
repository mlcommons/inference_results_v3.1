...
export PYTORCH_VERSION=v2.1
VERSION=3.1
export IMAGE_NAME=mlperf_inference_gptj:${VERSION}



echo "Building GPT-J workflow container"
DOCKER_BUILDKIT=1 docker build  --no-cache --progress=plain ${DOCKER_BUILD_ARGS} -f Dockerfile -t ${IMAGE_NAME} ../../../../
