...
class H100X8_HighAccuracy(H100X8):
    precision = "fp16"
    single_stream_expected_latency_ns = H100X8.single_stream_expected_latency_ns * 2


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class H100X8_Triton(H100X8):
    use_triton = True
...
class H100X8_HighAccuracy_Triton(H100X8_HighAccuracy):
    use_triton = True
