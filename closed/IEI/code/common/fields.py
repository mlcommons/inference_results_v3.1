...
class Fields(Enum):
    ...
    instance_count: Field = Field(
        "instance_count",
        "Set intance count for each GPU.",
        value_type=int,
    ...
    coalesced_tensor: Field = Field(
        ...
        value_type=bool,
        supported_actions=_HARNESS_ACTIONS,
        supported_benchmarks=(Benchmark.BERT, Benchmark.GPTJ, Benchmark.GPT175, Benchmark.DLRMv2))
    ...
    enable_sort: Field = Field(
        "enable_sort",
        "Sort QSL samples before inference. Enable sorting might reduce offline accuracy",
        value_type=bool,
        supported_actions=_HARNESS_ACTIONS,
        supported_systems=(SystemClassifications.gpu_based,),
