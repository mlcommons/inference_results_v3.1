...
#ifndef SYNC_WORK_QUEUE_HPP
#define SYNC_WORK_QUEUE_HPP
    ...
    void getBatch(std::vector<mlperf::QuerySample>& batch, size_t maxBatchSize)
    {
        ...
        if (actualBatchSize > 0)
        {
            NVTX_GLOBAL_START_WITH_PAYLOAD(
                nvtxGetBatch, "SyncWorkQueue::GetBatch", nvtx::COLOR_YELLOW_7, mWorkQueue.size());
