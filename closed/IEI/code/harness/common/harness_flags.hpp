...
DEFINE_uint32(instance_count,1, "Instance count for each device");
...
DEFINE_bool(use_pva, false,
    "RetinaNet DLA + PVA orchestration. Requires 1 DLA backbone engine and 1 NMS PVA plugin engine when set to True. "
    "Default: False");
