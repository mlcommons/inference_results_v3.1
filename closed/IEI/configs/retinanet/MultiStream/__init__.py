...
class Starship_GH100_ARMx1(MultiStreamGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6_A40x1(MultiStreamGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6_A40x2(NF5468M6_A40x1):
    system = KnownSystem.NF5468M6_A40x2
    gpu_batch_size = 4
    gpu_copy_streams = 1
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6_A40x2_Triton(NF5468M6_A40x2):
    use_triton = True
