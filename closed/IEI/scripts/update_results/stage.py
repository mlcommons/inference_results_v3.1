...
def stage_result_candidates(candidates: Tree, staging_dir: str, dry_run: bool = False):
    ...
    for system_name, benchmarks in candidates.tree.items():
        ...
        for benchmark, scenarios in benchmarks.items():
            ...
            # NOTE: Add GPTJ in v3.1. We might use int8/fp8 in v4.0
            # TODO: GPTJ-99.9 and 99 are currently using different configs. Don't overwrite until we figure out the bugs.
            # NOTE: Also add DLRMv2 in v3.1. Subject to change in v4.0
            if benchmark in {"dlrm-99.9", "dlrm-v2-99.9", "3d-unet-99.9"}:
