...
def main():
    ...
    # python3 -m code.gptj.tensorrt.infer --engine_file /tmp/gptj6b.b8.int8.engine --num_samples=1200 --batch_size=8
    # To run the pytorch tester:
    # python3 -m code.gptj.tensorrt.infer --pytorch --num_samples=1200 --batch_size=8
