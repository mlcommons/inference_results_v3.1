...
$(PROJECT_ROOT)/closed/ConnectTechInc. This will remain the same even if CWD changes"""
...
class Benchmark(AliasedNameEnum):
    ...
    GPT175: AliasedName = AliasedName("gpt3", ("gpt175", "gpt175b", "gpt-175", "gpt-l"))
...
G_DEFAULT_HARNESS_TYPES: Dict[Benchmark, HarnessType] = {
    ...
    Benchmark.GPT175: HarnessType.Custom,
