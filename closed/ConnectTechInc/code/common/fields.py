...
class Fields(Enum):
    ...
    warmup_duration: Field = Field(
        ...
        value_type=float,
        supported_actions=_HARNESS_ACTIONS,
        supported_benchmarks=_LWIS_BENCHMARKS + (Benchmark.DLRM, Benchmark.DLRMv2))
    ...
    coalesced_tensor: Field = Field(
        ...
        value_type=bool,
        supported_actions=_HARNESS_ACTIONS,
        supported_benchmarks=(Benchmark.BERT, Benchmark.GPTJ, Benchmark.GPT175, Benchmark.DLRM, Benchmark.DLRMv2))
    ...
    sample_partition_path: Field = Field(
        ...
        value_type=str,
        supported_actions=_HARNESS_ACTIONS,
        supported_benchmarks=(Benchmark.DLRM, Benchmark.DLRMv2))
    ...
    mega_table_npy_file: Field = Field(
        ...
        value_type=str,
        default='/home/mlperf_inf_dlrmv2/model/embedding_weights/mega_table_fp16.npy',
    ...
    use_fp8: Field = Field(
        ...
        supported_actions=_HARNESS_ACTIONS + (Action.GenerateEngines,),
        supported_systems=(SystemClassifications.gpu_based,),
        supported_benchmarks=(Benchmark.BERT, Benchmark.GPTJ, Benchmark.GPT175))

    tensor_parallelism: Field = Field(
        "tensor_parallelism",
        "Tensor Parallelism value for GPT",
        value_type=int,
        supported_actions=_HARNESS_ACTIONS + (Action.GenerateEngines,),
        supported_systems=(SystemClassifications.gpu_based,),
        supported_benchmarks=(Benchmark.GPTJ, Benchmark.GPT175))
