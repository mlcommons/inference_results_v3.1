...
class KnownGPU(MatchableEnum):
    ...
    Orin = GPU(AliasedName("Orin", patterns=(re.compile(r"(Jetson AGX Orin)|(NVIDIA Orin Jetson-Small Developer Kit)"),)),
               ...
               MATCH_ANY,
               MATCH_ANY)
    Orin_NX = GPU(AliasedName("Orin_NX", patterns=(re.compile(r"(NVIDIA Orin NX Developer Kit)|(NGX007)|(Orin NX NGX007)|(Orin NX NGX012)"),)),
                  AcceleratorType.Integrated,
                  MATCH_ANY,
                  MATCH_ANY,
                  MATCH_ANY,
...
class KnownCPU(MatchableEnum):
    Grace_ARM = CPU(AliasedName("aarch64_0", ("NVIDIA Grace CPU"),),
