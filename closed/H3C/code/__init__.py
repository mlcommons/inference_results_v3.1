...
G_BENCHMARK_CLASS_MAP = {
    ...
    Benchmark.GPTJ: ModuleLocation("code.gptj6b.tensorrt.gptj6b", "GPTJ6BBuilder"),
}
G_HARNESS_CLASS_MAP = {
    ...
    "gptj_harness": ModuleLocation("code.gptj6b.tensorrt.harness", "GPTJHarness"),
    "gpt175_harness": ModuleLocation("code.gpt175b.tensorrt.harness", "GPT175Harness"),
...
def get_harness(config, profile):
    ...
    if "triton_unified" in config.get("config_ver"):
        ...
        k = "gptj_harness"
        config["inference_server"] = "custom"
    elif Benchmark.GPT175 == benchmark:
        k = "gpt175_harness"
        config["inference_server"] = "custom"
