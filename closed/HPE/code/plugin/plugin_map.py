...
class LoadablePlugins(Enum):
    ...
    # TODO MLPINF-2262 modify path when finalized
    TRTLLMPlugin = LoadablePlugin("../TRTLLM/cpp/build_cpp/tensorrt_llm/plugins/libnvinfer_plugin.so")
    DLRMInteractionsPlugin = LoadablePlugin("DLRMInteractionsPlugin/libdlrminteractionsplugin.so", [lambda x: not SystemClassifications.is_orin()])
...
base_plugin_map = {
    ...
    Benchmark.GPTJ: [LoadablePlugins.TRTLLMPlugin],
    Benchmark.GPT175: [LoadablePlugins.TRTLLMPlugin],
