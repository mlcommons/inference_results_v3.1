...
conda install gperftools cmake jemalloc==5.2.1 pybind11==2.10.4 llvm-openmp==16.0.6 -c conda-forge -y
conda install gcc=12.3 gxx=12.3 cxx-compiler ninja -c conda-forge -y

pip install setuptools==58.2.0
# ========== Install INC deps ===========
python -m pip install cpuid nltk evaluate protobuf==3.20.3 absl-py rouge-score==0.1.2 tqdm numpy cython nltk evaluate absl-py rouge-score==0.1.2 tqdm sentencepiece accelerate opencv-python-headless==4.5.3.56
...
cp ${DIR}/first_token_optim.diff .
patch -p1 < first_token_optim.diff
echo "IPEX Patch applied successfully" 
