...
VERSION=3.1
export IMAGE_NAME=mlperf_inference_dlrm2_bf16:$VERSION

echo "Building DLRM2-99.9 workflow container"
DOCKER_BUILDKIT=1 docker build  --no-cache --progress=plain ${DOCKER_BUILD_ARGS} -f Dockerfile --no-cache -t ${IMAGE_NAME} ../../../..
