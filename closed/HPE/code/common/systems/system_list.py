...
# Grace-Hopper supoerchip blade
add_systems("Starship_GH100_ARMx{}", "Starship_GH100_ARMx{}", KnownCPU.Grace_ARM.value,
            KnownGPU.GH100_94GB.value, [1], Memory(500, ByteSuffix.GiB))
...
### HPE ###
add_systems("A100_SXM_80GBx{}", "HPE_ProLiant_XL675d_Gen10_Plus_A100_SXM_80GBx{}",
            MatchAllowList([KnownCPU.AMD_EPYC_7763.value, KnownCPU.x86_64_Generic.value]),
...
class SystemClassifications:
    ...
    def start_from_device_enabled(cls, sys):
        return sys in [
            KnownSystem.HPE_ProLiant_XL675d_A100_SXM_80GBx8,
            ...
            KnownSystem.Starship_GH100_ARMx1,
        ]
