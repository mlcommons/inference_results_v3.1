...
7. `cm run script --tags=get,ml-model,image-classification,resnet50,raw,_tf,_fp32`


8. `cm run script --tags=get,dataset,image-classification,imagenet,preprocessed,_default,_NHWC,_full`
