...
NVIDIA's MLPerf Inference submission stores the models, datasets, and preprocessed datasets in a central location we refer to as a "Scratch Space". The "Scratch Space" is mounted to every NVIDIA's submission system via CIFS.
