...
./run2 -t 0 -i "8:3:224:224" -o "8:64" -r 0 -s 1 -b 8 -d /mnt/mlperf_sr/mlperf_resnet50_dataset.dat -m "false" -l /mnt/mlperf_august/libs_argmax/ -a /mnt/mlperf_august/models_final
