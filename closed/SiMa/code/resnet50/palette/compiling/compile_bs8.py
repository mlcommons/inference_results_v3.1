...
MODEL_DIR = './'
OUTPUT_DIR = f'./output_bs8_{calib_method.value}_final'
...
def compile_model(model_name: str, arm_only: bool):
    ...
    print(f"Compiling model {model_name} with batch_size=8 and arm_only={arm_only}")
