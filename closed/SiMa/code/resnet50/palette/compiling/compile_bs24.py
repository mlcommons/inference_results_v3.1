...
MODEL_DIR = './'
OUTPUT_DIR = f'./output_bs24_{calib_method.value}_final'
...
def compile_model(model_name: str, arm_only: bool):
    ...
    print(f"Compiling model {model_name} with batch_size=24 and arm_only={arm_only}")
    ...
    saved_model_directory = "sdk_bs24"
