...
"""
Pre-process Calibration Data - only runnable on Saruman.
"""
...
if __name__ == '__main__':
    ...
    cal_map_file = '/project/davinci_users/software/victor.bittorf/mlperf/amy/mlperf_resnet50/calibration/cal_map.txt'
