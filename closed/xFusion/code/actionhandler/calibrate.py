...
class CalibrateHandler(ActionHandler):
    ...
    def handle(self):
        ...
        if self.benchmark == Benchmark.ResNet50:
            ...
            logging.info("Use the v3.0 calibration cache instead:")
            logging.info("https://raw.githubusercontent.com/mlcommons/inference_results_v3.0/main/closed/xFusion/code/resnet50/tensorrt/calibrator.cache")
