...
POWER_SERVER_IP_MAP = {
    ...
    "a1u2n2g-0275-01-jetson": "10.110.39.34",
    "ipp1-2469-jetson": "10.110.39.34",
    "a1u2n2g-0277-01-jetson": "10.110.39.34",
    "a1u2n2g-0277-02-jetson": "10.110.39.34",
    "ipp1-1470": "10.110.39.34",
    "ipp1-1470": "10.110.39.34",
    "viking-cr-194": "10.110.39.34",
}
...
if __name__ == "__main__":
    ...
    if args.use_win:
        print(f"WARNING: Windows power server is DEPRECATED!!!")
