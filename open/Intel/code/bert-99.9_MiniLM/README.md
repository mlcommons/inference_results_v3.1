...
|:----------------:|:------:|:-------:|:--------:|
| Bert-MiniLM L8 | 90.7962 | Sapphire Rappids | 5945.32 |
## Prerequisite
...
git checkout 852a9064972f65ed5f20fb997adca9c1accaa112
git submodule sync
...
+ Set `bert.Offline.target_qps=8000` when you run minilm on SPR machine.
...
```
mkdir mlperf_output
GLOG_minloglevel=2  INST_NUM=28 ./build/inference_sut --model_conf=./minilm_l8_int8ir/conf.yaml --model_weight=./minilm_l8_int8ir/model.bin  --sample_file=./datasets/ --output_dir=./mlperf_output --mlperf_config=./mlperf.conf --user_config=user.conf
```
...
```
mkdir mlperf_output
GLOG_minloglevel=2  INST_NUM=28 ./build/inference_sut --model_conf=./minilm_l8_int8ir/conf.yaml --model_weight=./minilm_l8_int8ir/model.bin  --sample_file=./datasets/ --output_dir=./mlperf_output --mlperf_config=./mlperf.conf --user_config=user.conf  --accuracy=true
