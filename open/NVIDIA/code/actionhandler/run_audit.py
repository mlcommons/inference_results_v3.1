...
class RunAuditHandler(RunHarnessHandler):
    ...
    def __init__(self, test_name, benchmark_conf, power_controller, use_gpu=True, profiler=None, verify=True):
        ...
        super().__init__(benchmark_conf, power_controller, use_gpu=use_gpu, profiler=profiler,
