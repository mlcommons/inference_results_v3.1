...
class RunHarnessHandler(GenerateConfFilesHandler):
    ...
    def __init__(self, benchmark_conf, power_controller, use_gpu=True, profiler=None, measure_power=False, skip_postprocess=False):
        ...
        Args:
            ...
            skip_postprocess (bool): If True, skips accuracy log parsing and statistics reporting in cleanup().
                                     (Default: False)
        """
        super().__init__(benchmark_conf, use_gpu=use_gpu, skip_file_checks=False)
