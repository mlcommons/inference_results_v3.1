...
def main():
    ...
    sut = SUT(args.num_proc, args.cpus_per_proc, args.library_path, initial_core=args.cores_offset, batch_size=args.batch_size, dataset_path=args.dataset_path, 
            workers_per_proc=args.workers_per_proc, warmup=args.warmup, model_path=args.model_path, total_sample_count=args.total_sample_count, pad_inputs=args.pad_inputs)
