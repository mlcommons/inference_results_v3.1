...
export LD_PRELOAD=${LD_PRELOAD}:/home/hengyume/anaconda3/envs/gpt-j-env/lib/libiomp5.so
export LD_PRELOAD=${LD_PRELOAD}:/home/hengyume/anaconda3/envs/gpt-j-env/lib/libtcmalloc.so

export num_physical_cores=`lscpu -b -p=Core,Socket | grep -v '^#' | sort -u | wc -l`
num_numa=$(numactl --hardware|grep available|awk -F' ' '{ print $2 }')

/home/hengyume/anaconda3/envs/gpt-j-env/bin/python ../../user_config.py
USER_CONF=user.conf
...
/home/hengyume/anaconda3/envs/gpt-j-env/bin/python runner.py --workload-name gptj \
	--scenario Offline \
	--mode Performance \
	--num-proc ${NUM_PROC} \
