...
VALIDATION_DATA_JSON=./data/validation-data/cnn_dailymail_validation.json
LIBRARY_PATH=./graph/build/lib/libGptjPyBind.so
MODEL_PATH=./graph/models/gpt-j-q4.bin
CHECKPOINT_DIR=./data/gpt-j-checkpoint/
